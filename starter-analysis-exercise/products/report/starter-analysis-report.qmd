...
**Savanna Torres** contributed to this exercise.
...
1.  Eye Color - Color of the person's eyes
2.  Waist size - Waist size of the person in inches
...
#| echo: FALSE
resulttable3=readRDS("../../results/tables-files/resulttable3.rds")
...
```{r}
#| label: fig-boxplot
#| fig-cap: "Boxplot of Height by Eye Color."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","eye-color-height-boxplot.png"))

```

@fig-scatter shows a scatter figure produced by one of the R scripts.

```{r}
#| label: fig-scatter
#| fig-cap: "Scatterplot of Weight vs. Waist Size."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","weight-waist-scatter.png"))
